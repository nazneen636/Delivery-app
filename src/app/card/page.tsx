...
const card = () => {
  return (
    <div className="bg-[#FFFFFF] p-4 md:p-8">
      ...
      {/* 1st div  */}
      <div className="flex flex-col lg:flex-row gap-4 2xl:gap-10 justify-between">
        <div className="w-full lg:w-1/2">
        <div className="card bg-[#E97A20] bg-gradient-to-tr from-[#E97A20] from-50% to-[#F4BC8F] w-full lg:w-[75%] h-[228px] p-6 rounded-2xl flex flex-col justify-between">

            <div>
            <div className="flex justify-between items-center">
              <p className="text-[18.33px] text-white font-[400]">name</p>
              <Image src={mastercard} width={50} height={50} alt="image" />
            </div>

            <h3 className="text-[26.27px] font-[400] text-white">
              Alex benjamin
            </h3>
            </div>
            ...
            <div className="flex gap-12">
                ...
                <div className="flex">
                    <IoStar className="text-white"></IoStar>
                    <IoStar className="text-white"></IoStar>
                    <IoStar className="text-white"></IoStar>
                    <IoStar className="text-white"></IoStar>
                </div>
                ...
                <p className="text-white">1590</p>
            </div>

            
            <div>
              <h3 className="text-[18.33px] text-white font-[400]">Balance</h3>
                <h3 className="text-[18.33px] text-white font-[400]">5,580,200</h3>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-end">
          <div className="flex gap-7">
            <div className="w-[117px] h-[117px] xl:w-[157px] xl:h-[157px] 2xl:w-[170px] 2xl:h-[170px] bg-[#F3ABA7] rounded-full flex justify-center items-center">
              <Image src={profileImg} width={180} height={180} alt="image" />
            </div>

            <div className="">
              <h2 className="font-medium text-[36px] xl:text-[40px] 2xl:text-[45px] text-[#000000]">
                Adeniyi O
              </h2>
              <h3 className="font-normal text-[18px] lg:text-[22px] xl:text-[25px] 2xl:text-[30px]">
                adeniyiokunuga46@gmail.com
              </h3>
              <h3 className="text-center mt-5 text-[#00000080] font-medium lg:text-[18px] 2xl:text-[24px]">
                Total balance
              </h3>
              <h2 className="text-[30px] font-bold text-center mt-1 lg:text-[29px] 2xl:[43px]">
                NGN 56,000.00
              </h2>
            </div>
          </div>
          ...
          <div className="flex justify-between w-[70%] mt-7 2xl:mt-9">
            <button className="bg-[#000000]  w-[45%] 2xl:w-[40%] text-white px-7 py-2 2xl:py-3 rounded-lg flex justify-center items-center gap-2 cursor-pointer">
              Send{" "}
              <AiOutlineUpload className="text-white font-bold text-xl"></AiOutlineUpload>{" "}
            </button>
            <button className="bg-[#000000] w-[45%] 2xl:w-[40%] text-white px-5 py-2 2xl:py-3 rounded-lg flex justify-center items-center gap-2 cursor-pointer">
              Receive
      ...
      {/* secound div  */}
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 mt-14 lg:mt-7">
        <div className="w-full lg:w-1/2">
          <h1 className=" text-[26px] lg:text-[30px] font-[500] text-[#000000]">
            Statistic
          </h1>
